  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Tasky 6 - Streamlining your daily workflow with a comprehensive todo list app, designed for efficiency, productivity and simplicity. Prioritize, organize, and conquer your tasks with Tasky 6."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Tasky 6 - Streamlining your daily workflow with a comprehensive todo list app, designed for efficiency, productivity and simplicity. Prioritize, organize, and conquer your tasks with Tasky 6.`}
            </Text>
            <Box
